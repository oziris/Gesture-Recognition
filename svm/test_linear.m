function [predicted_label, accuracy, decision_values] = test_linear(test_data, test_label, svm_model, data_trans, normalization)
%TEST_LINEAR Test svm model with a linear kernel.
% 
% [predicted_label, accuracy, decision_values] = test_linear(test_data, test_label, svm_model, data_trans, normalization)
%
